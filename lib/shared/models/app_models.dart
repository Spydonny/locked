...
class ExerciseLibraryItem {
  ...
  factory ExerciseLibraryItem.fromJson(Map<String, dynamic> json) {
    return ExerciseLibraryItem(
      ...
      category: (json['category'] ?? json['muscle_group'] ?? json['muscleGroup'] ?? '').toString(),
      equipment: (json['equipment'] ?? '').toString(),
      personalRecord: (json['personalRecord'] ?? json['personal_record'] ?? '').toString(),
    );
  }
}
...
class RoutinePlan {
  ...
  factory RoutinePlan.fromJson(Map<String, dynamic> json) {
    final scheduleDays = (json['schedule_days'] as List?)?.cast<dynamic>() ?? const [];
    return RoutinePlan(
      id: (json['id'] ?? json['_id'] ?? '').toString(),
...
class AnalyticsSnapshot {
  ...
  factory AnalyticsSnapshot.fromJson(Map<String, dynamic> json) {
    final focus = (json['muscle_focus'] ?? json['focusDistribution'] ?? json['focus_distribution']) as List? ?? const [];
    final trend = (json['volume_trend'] ?? json['volumeTrend'] ?? json['volume_trend']) as List? ?? const [];
    return AnalyticsSnapshot(
      consistencyScore: (json['consistency_score'] as num?)?.toInt() ?? (json['consistencyScore'] as num?)?.toInt() ?? 0,
      fatigueScore: (json['fatigue_score'] as num?)?.toInt() ?? (json['fatigueScore'] as num?)?.toInt() ?? 0,
      focusDistribution: focus.whereType<Map>().map((e) => ChartDatum.fromJson(e.cast<String, dynamic>())).toList(),
      volumeTrend: trend.whereType<Map>().map((e) => ChartDatum.fromJson(e.cast<String, dynamic>())).toList(),
    );
  }
}
...
class NutritionSnapshot {
  ...
  factory NutritionSnapshot.fromJson(Map<String, dynamic> json) {
    ...
    return NutritionSnapshot(
      ...
      hydrationLiters: (json['hydrationLiters'] as num?)?.toDouble() ?? (json['hydration_liters'] as num?)?.toDouble() ?? 0,
      meals: mealsJson.whereType<Map>().map((e) => MealEntry.fromJson(e.cast<String, dynamic>())).toList(),
    );
  }
}
...
class PhysiqueSnapshot {
  ...
  factory PhysiqueSnapshot.fromJson(Map<String, dynamic> json) {
    ...
    return PhysiqueSnapshot(
      currentWeight: (json['currentWeight'] as num?)?.toDouble() ?? (json['current_weight'] as num?)?.toDouble() ?? 0,
      bodyFat: (json['bodyFat'] as num?)?.toDouble() ?? (json['body_fat'] as num?)?.toDouble() ?? 0,
      chest: (json['chest'] as num?)?.toInt() ?? 0,
      waist: (json['waist'] as num?)?.toInt() ?? 0,
      trend: trendJson.whereType<Map>().map((e) => ChartDatum.fromJson(e.cast<String, dynamic>())).toList(),
    );
  }
}
